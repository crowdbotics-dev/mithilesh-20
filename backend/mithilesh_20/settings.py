"""
Django settings for mithilesh_20 project.
...
ROOT_URLCONF = 'mithilesh_20.urls'
...
WSGI_APPLICATION = 'mithilesh_20.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithilesh_20 API",
    "DESCRIPTION": "API documentation for mithilesh_20 App",
    "VERSION": "v1",
}
